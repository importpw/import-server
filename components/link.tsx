...
/** Minimal posix-style path join (used in both server and client). */
...
/** Resolve a relative URL against a base pathname. */
...
export default function MarkdownLink({
	...
	// Map hard-coded `https://import.sh` links to root-relative for dev/staging.
